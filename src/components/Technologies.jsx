...
import { SiExpress, SiMongodb, SiPrisma, SiZod } from "react-icons/si";
    ...
    <div className="border-b border-neutral-800 p-24">
      ...
      >
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-700 p-4"
        >
          <GrDocker className="text-7xl text-sky-700" />
        </motion.div>
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-700 p-4"
        >
          <SiPrisma className="text-7xl text-blue-950" />
        </motion.div>
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-700 p-4"
        >
          <SiZod className="text-7xl text-blue-950" />
        </motion.div>
      </motion.div>
    </div>
  );
